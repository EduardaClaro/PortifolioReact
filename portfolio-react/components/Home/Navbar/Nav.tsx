      ...
      >
        ...
        <div className="hidden lg:flex items-center space-x-5">
          {NavLinks.map((link) => (
            <button
              ...
              className="text-lg md:text-xl hover:text-purple-500 text-white font-semibold transition-all duration-300 ease-in-out "
            >
              {link.Label}
            </button>
          ))}
        ...
        <div className="flex items-center space-x-4">
          <a
            ...
            target="_blank"
            className="px-4 sm:px-6 py-2 sm:py-2.5 text-sm sm:text-lg cursor-pointer rounded-full bg-purple-900 hover:bg-purple-950 transition-all duration-300 ease-in-out text-white flex items-center space-x-2 hover:scale-105"
          >
            <BiDownload size={20} />
